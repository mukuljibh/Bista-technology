        ...
        <footer className="space-y-8">
            ...
            <div className=" text-sm text-gray-700 flex flex-col-reverse justify-between items-center py-5">
                ...
                <div className="flex gap-2">
                    <a
                        href="https://www.linkedin.com/company/bistatechnologies/about/"
                        target="_blank"
                        aria-label="Visit Bista Technologies on LinkedIn"
                    >
                    ...
                    <a
                        href="https://www.instagram.com/official_bistatechnologiesinc/"
                        target="_blank"
                        aria-label="Visit Bista Technologies on Instgram">
