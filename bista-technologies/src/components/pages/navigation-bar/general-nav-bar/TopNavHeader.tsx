export default function TopNavHeader() {
    return (
        <div className={`bg-sky-700 py-2 w-full transition-all`}>
            <div className=" flex lg:justify-end justify-center gap-5 lg:mr-10">
                ...
                <div className="flex gap-2">
                    ...
                    <a href="https://www.linkedin.com/company/bistatechnologies/about/" target="_blank" className="border-2 inline-block p-1 border-white" aria-label="Visit Bista Technologies on LinkedIn">
                    ...
                    <a href="https://www.instagram.com/official_bistatechnologiesinc/" target="_blank" className="border-2 inline-block p-1 border-white" aria-label="Visit Bista Technologies on Instagram">
