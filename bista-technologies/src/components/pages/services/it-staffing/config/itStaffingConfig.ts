const itStaffingConfig = [
    {
        heading1: "Talent Flow",
        heading2: "Project Management",
        image: { imageSrc: "https://www.bistatechnologies.com/static/Popular%20Project%20Management%20Template%20Set.jpeg", alt: "talent flow logo" },
    ...
    },
    {
        ...
        image: { imageSrc: "https://www.bistatechnologies.com/static/Project_Based_IT_Staffing.jpeg", alt: " IT staffing logo" },
    ...
    },
    {
        ...
        image: { imageSrc: "https://www.bistatechnologies.com/static/Innovation-Recuritment.jpeg", alt: " Hire logo" },
    ...
    },
    {
        ...
        image: { imageSrc: "https://www.bistatechnologies.com/static/project-management.jpg", alt: "supply logo" },
    ...
    },
    {
        ...
        image: { imageSrc: "https://www.bistatechnologies.com/static/e0860f534b29769b6b83511e5f22bf06.jpg", alt: "Client-Centric logo" },
...
const itCardsConfig = [{ heading: "Construct a High performance team", description: "It involves recognizing and leveraging individual strengths, promoting a culture of collaboration and trust, assessing teamwork dynamics, empowering team members to take ownership, and consistently offering feedback and acknowledgment to maintain motivation and drive success.", imageSrc: "https://www.bistatechnologies.com/static/high-performance-team.jpg", css: "border-2 hover:border-gray-400", animationTime: 0 },
{ heading: "faster a Positive Work Environment", description: "It involves promoting open communication, encouraging teamwork, recognizing achievements, providing growth opportunities, and prioritizing work-life balance. By cultivating a supportive and inclusive atmosphere, employees feel valued, motivated, and empowered to excel in their roles.", imageSrc: "https://www.bistatechnologies.com/static/qa.png", css: "border-2 hover:border-green-700", animationTime: 200 },
{ heading: "Enhance Workflow Visibility Human", description: "It involves enhancing communication, streamlining processes, and utilizing technology tools. By implementing transparent communication channels, progress tracking systems, and visual workflow diagrams, employees can have a better understanding of their roles, responsibilities, and the overall workflow.", imageSrc: "https://www.bistatechnologies.com/static/ps.png.crdownload", css: "border-2 hover:border-sky-700", animationTime: 300 },
{ heading: "Implement Agile Methodologies", description: "Implementing agile methodologies involves adopting flexible, iterative approaches to project management and product development. This includes practices such as Scrum, Kanban, or hybrid models tailored to your team's needs. By breaking work into smaller, manageable chunks, conducting regular stand-ups.", imageSrc: "https://zenkit.com/wp-content/uploads/2018/03/thumbnail.en79.jpg", css: "border-2 hover:border-sky-700", animationTime: 500 }
]
export { itStaffingConfig, itCardsConfig }