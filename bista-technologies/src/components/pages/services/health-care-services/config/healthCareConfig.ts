...
const healthcareCardsConfig = [
    { heading: "Expertise", description: "Years of experience in the healthcare staffing industry.", imageSrc: "/services/health-care/5.webp", css: "border-2 hover:border-gray-400", animationTime: 0 },
    { heading: "Quality Assurance", description: "Rigorous screening process for the best candidates.", imageSrc: "/services/health-care/6.png", css: "border-2 hover:border-green-700", animationTime: 200 },
    { heading: "Personalized Service", description: "Understanding your specific needs to find the right match.", imageSrc: "/services/health-care/7.crdownload", css: "border-2 hover:border-sky-700", animationTime: 300 },
    { heading: "24/7 Support", description: "Available around the clock for any staffing emergencies.", imageSrc: "/services/health-care/8.png", css: `border-2 hover:border-orange-600`, animationTime: 400 }
]
