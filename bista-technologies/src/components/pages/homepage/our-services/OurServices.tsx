...
import { ourServicesData } from "../config/home_page.config"
import Card from "../../../../ui/merged_components/service-cards/Card"
export default function OurServices() {
    const { isCardVisible } = useObserver('ourServices', 0.5)
    return (
        <div className="ourServices relative flex flex-wrap gap-16 justify-center  py-32 bg-purple-50 lg:px-20 px-10 ">
