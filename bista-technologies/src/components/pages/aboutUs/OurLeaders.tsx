...
export default function OurLeaders() {
    return (
        ...
        >
            <div className="bg-white mt-10 text-white p-6 rounded-lg shadow-md mb-4 w-full flex items-center justify-center">
                ...
                <div className="rounded overflow-hidden flex flex-col max-w-xl mx-auto">
                    <a href="#" className="block">
                        <img
                            ...
                            src="https://www.bistatechnologies.com/static/ourleader2.jpg"
                            alt="Leadership"
                        />
                    </a>
                ...
                <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                    ...
                    <div className="flex flex-col items-center p-5 pb-10">
                        <img
                            ...
                            src="https://www.bistatechnologies.com/static/LEADER-PIC-WITH%20LIGHT-BLUE.png"
                            alt="Vipul Bhatia"
                        />
                        <h5 className="mb-1 text-xl font-medium text-gray-900">Vipul Bhatia</h5>
                        <span className="text-sm text-gray-500">Co-founder and Managing Director, Bista Technologies Inc.</span>
                    </div>
                </div>
            </div>
        </motion.div>
