...
export default function NavElements({ label, submenu }: NavElementsProps) {
    ...
    return (
        <div className={` p-3  hidden lg:block hover:text-black ${isOpen ? 'bg-zinc-200' : ''}`} onMouseEnter={handleMenu} onMouseLeave={handleMenu}>
            ...
            <div className="absolute bg-white mt-3  ">
